...
class PenguinRecord(BaseModel):
    ...
    bill_length_mm: Optional[float] = Field(None, ge=0, description="Bill length in millimeters")
    bill_depth_mm: Optional[float] = Field(None, ge=0, description="Bill depth in millimeters")
    flipper_length_mm: Optional[float] = Field(None, ge=0, description="Flipper length in millimeters")
    body_mass_g: Optional[float] = Field(None, ge=0, description="Body mass in grams")
    year: Optional[int] = Field(None, ge=2007, le=2009, description="Year of observation")
