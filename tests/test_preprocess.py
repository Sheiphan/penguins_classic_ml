...
from src.data.schema import NUMERIC_FEATURES, CATEGORICAL_FEATURES
...
class TestPenguinPreprocessor:
    ...
    def test_fit_transform(self, sample_data):
        ...
        assert X_transformed.shape[1] > len(NUMERIC_FEATURES)  # Should have more columns due to one-hot encoding
    ...
    def test_numeric_preprocessing(self, sample_data):
        ...
        numeric_cols = [col for col in X_transformed.columns 
    ...
    def test_categorical_preprocessing(self, sample_data):
        ...
        assert len(categorical_cols) > len(CATEGORICAL_FEATURES)  # Should have more columns due to encoding
    ...
    def test_transform_new_data(self, sample_data):
        ...
        assert X_new_transformed.shape[1] == preprocessor.fit_transform(sample_data).shape[1]
