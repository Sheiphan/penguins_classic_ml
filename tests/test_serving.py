...
def model_registry_with_model(temp_model_dir, simple_model):
    ...
    metrics = {"accuracy": 0.95, "f1_score": 0.94, "precision": 0.93, "recall": 0.96}
...
class TestPenguinPredictor:
    ...
    def test_validate_input_invalid_island(
        self, temp_model_dir, model_registry_with_model
    ):
    ...
    def test_predict_success(
        self, mock_predict, temp_model_dir, model_registry_with_model
    ):
...
class TestFastAPIEndpoints:
    ...
    def test_predict_endpoint_success(
        self, mock_predictor, client, valid_predict_request
    ):
    ...
    def test_predict_endpoint_invalid_data(self, client):
        ...
        assert response.status_code in [
            ...
            500,
            503,
        ]  # Validation, server error, or service unavailable
    ...
    def test_batch_predict_endpoint(
        ...
        batch_request = {"instances": [valid_predict_request]}
