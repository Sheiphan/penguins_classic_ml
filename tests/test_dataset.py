...
class TestPenguinDataLoader:
    ...
    def sample_raw_data(self):
        ...
        return pd.DataFrame({
            ...
            "Date Egg": ["11/11/07", "11/11/07", "11/16/07", "11/16/07", "11/16/07"]
        })
    ...
    def test_save_processed_data(self, mock_mkdir, mock_exists, mock_read_csv, sample_raw_data):
...
class TestLoadPenguinsData:
    ...
    def test_load_penguins_data_with_split(self, mock_loader_class):
        ...
        mock_loader = MagicMock()
        mock_loader.train_test_split.return_value = ("X_train", "X_test", "y_train", "y_test")
        mock_loader_class.return_value = mock_loader
